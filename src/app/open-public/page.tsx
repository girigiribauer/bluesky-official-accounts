      ...
      <div>
        ...
        <div className="page-content">
          ...
          <section className="page-section">
            ...
            <p>
              <strong>
                「ログインしなければ見られない」という制限は、広報において致命的な機会損失
              </strong>
              です。BlueskyはWeb標準に準拠しており、アカウントを持たないユーザーや検索エンジンに対しても常に開かれています。情報の到達をプラットフォーム内に閉じ込めず、公式サイトやプレスリリースと同じ透明性を持って、全インターネット層へ届けられます。
            </p>
          </section>
          ...
          <section className="page-section">
            ...
            <p>
              ...
              場合によっては特定の偏った主義・主張に賛同していると受け取られかねません。{" "}
          ...
          <section className="page-section">
            ...
            <p>
              ...
              <br />
              X の経営者は X を対戦型SNSだと自身で言及していますが、本来不必要な炎上リスクを避けつつも、ユーザーを完全に見捨てずに X で情報提供だけを行うスタイルは、現時点のSNS戦略の1つの最適解かもしれません。
            </p>
          </section>
