...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://bluesky-official-accounts.vercel.app/faq",
  },
  openGraph: {
      ...
      <div>
        ...
        <div className="page-content">
          ...
          <section className={["page-section", styles.faqSection].join(" ")}>
            ...
            <p>
              現在、<strong>分野ごとの有識者によるモデレーションシステム</strong>への移行を段階的に進めています。
            </p>
            <p>
              投稿フォームの「分野」から一番近いものを1つ選んでください。どうしても当てはまるものがない場合は、根拠の方にその旨を記載しておいてください。
            </p>
            <p className={styles.backToTop}>
              <BackToTopButton />
            </p>
          ...
          <section className={["page-section", styles.faqSection].join(" ")}>
            ...
            <p>
              有志によって投稿されたものを、同じく有志によってチェック、公開作業、分類の見直しといったモデレーションを行っています。
              <strong>ご自身のお好きな分野をお選びいただき</strong>、その分野の範囲でモデレーターとしてご協力いただけます。
            </p>
            <p>
              モデレーターの行う作業には以下のようなものがあります。
            </p>
            <ul>
              <li>あなたの分野に匿名で投稿された申請のレビュー・公開</li>
              <li>あなたの分野での分類の作成・見直し</li>
              <li>他分野への推薦、など</li>
            </ul>
            <p>
              <strong>あなたが好きな分野で、「たくさん移行してきているよ」を可視化することで、あなたの好きが周りにいっぱい増えて、移行の促進が良いサイクルで回ります。</strong>ぜひともモデレーション参加をご検討ください。
            </p>
            <p className={styles.backToTop}>
              <BackToTopButton />
            </p>
          ...
          <footer className="page-footer">
            <PageNavigation prev="features" next="moderation" />
            <ShareButtons />
          </footer>
